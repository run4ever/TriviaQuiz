...
(function () {
  ...
  const ICONS = {
    ...
    mail: 'M3.5 6h17v12h-17zM3.8 6.6L12 13l8.2-6.4',
    lock: 'M6 11V8a6 6 0 0112 0v3M5 11h14v9H5zM12 15v2.5',
    user: 'M12 12a4 4 0 100-8 4 4 0 000 8zM5 20v-.5a6 6 0 016-6h2a6 6 0 016 6v.5',
    eye: 'M2.5 12S6 5.5 12 5.5 21.5 12 21.5 12 18 18.5 12 18.5 2.5 12 2.5 12zM12 15a3 3 0 100-6 3 3 0 000 6z',
    dice: 'M5 5h14v14H5zM9 9.5h.01M15 14.5h.01M12 12h.01',
    cloud: 'M7 18a4 4 0 01-.5-7.97 5.5 5.5 0 0110.6-1.2A3.75 3.75 0 0117 18zM9.5 13.5l1.8 1.8 3.2-3.5',
    logout: 'M14 17l5-5-5-5M19 12H8M11 5H5a1 1 0 00-1 1v12a1 1 0 001 1h6',
    edit: 'M4 20h4L19 9l-4-4L4 16zM14 6l4 4',
    sparkle: 'M12 3.5l1.7 5 4.8 1.6-4.8 1.6L12 16.7l-1.7-5L5.5 10l4.8-1.6zM18.5 15.5l.7 2 .8.3-.8.3-.7 2-.7-2-.8-.3.8-.3z',
    shield: 'M12 3l8 3v5.5c0 4.5-3.2 7.7-8 9-4.8-1.3-8-4.5-8-9V6z',
  };
